...
export default function HeroSection(){
    return(
        <section className="lg:py-20 mt-11 items-center">
            ...
            <h1 className="text-3xl sm:text-3xl lg:text-5xl text-white mb-6 font-extrabold"> Hello, I am Amna </h1>
            ...
            <Link
              ...
              <Link target="blank"
              href= "https://www.canva.com/design/DAGRTkjHnyw/rxMGN9ayghKSBGNSkaJEIA/edit?utm_content=DAGRTkjHnyw&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton"className=" px-6 py-3 inline-block rounded-full bg-transparent w-full sm:w-fit  hover:bg-slate-800 text-white border border-orange-300 mt-3"
                >Download CV </Link>
            </div>
            </div>
